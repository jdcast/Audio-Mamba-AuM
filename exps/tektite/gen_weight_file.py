...
parser.add_argument("--data_path", type=str, default='/home/jdcast/Audio-Mamba-AuM/exps/tektite/data/datafiles/train_data.json', help="the root path of data json file")
...
if __name__ == '__main__':
    ...
    label_count = np.zeros(5) # use number suitable for tektite dataset #np.zeros(527)
    ...
    label_weight = 1.0 / (label_count + 0.01) # use 1.0 since we only have 5 classes in tektite dataset
